...
\begin{center}
  \turbo{This whole section has been rewritten from scratch}
\end{center}
...
% \turbo{This section in particular needs redoing, largely to cover more contemporary high-mass work}
...
\begin{center}
  \turbo{Section has undergone heavy work}
\end{center}
...
% \turbo{End of re-written section}
...
% % \turbo{This section needs to be worked on, extend based on work on page 199 of Lamers and Cassinelli}
...
\note{
  However, as population III stars are theorised to be significantly higher mass \parencite{morganDustFormationEarly2003} the proportion of stars that underwent either a WR or analogous phase would be higher. As there were fewer low-mass stars, AGB stars would be significantly less viable in the low-metallicity early universe.
...
\begin{figure}[h]
  ...
  \caption[L$^\prime$ photometry of episodic dust making stars]{\turbo{This graph has been modified} L$^\prime$ photometry for episodic dust making stars, data derived from \textcite{crowther_dust_2003}, and provided by PM Williams in private correspondence. WR140 and WR137 in particular have extremely predictable dust forming events which correspond to periastron passage in both systems.}
