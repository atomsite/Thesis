...
Stellar winds have already been discussed to some extent in the previous section.
However, due to the significance of winds within this body of work, this phenomena must be discussed in greater detail to understand the dynamics of Colliding Wind Binary systems.
This section will cover in brief the study of stellar winds, particularly driving mechanisms from low and high mass stars.
...
This effect is not observed in low-mass stars, whose spectra typically peak in the visible light, while resonance lines typically have energies equivalent to UV photons (Fig. \ref{fig:planck-comp}).
...
This outsized influence on the local medium can be seen in the production of ejecta nebula, such as M1-67 produced by WR 124 (Fig. \ref{fig:wr124}).
