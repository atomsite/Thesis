...
Wolf-Rayet (WR) stars are produced when the largest early-type stars lose significant mass in the LBV stage (Fig. \ref{fig:mist-massloss}), while the internal core has the sufficient pressure and temperature required for helium burning.
...
% Iron
Finally, iron begins to deposit in the core of the star, all fusion processes at this point are endothermic.
...
Early astronomy relied solely on visible light observations, and at these wavelengths dust is nothing but a nuisance; obscuring dim and distant stars, as well as the innermost depths of the galaxy.
...
As the temperature increases, the rate of cooling peaks, in WCRs containing hydrogen this is consistent with recombination of electrons and hydrogen ions, releasing photons of energy $13.6\,\si{\electronvolt}$.
...
In order to explore the contribution of cooling to the structure of the WCR, we must do what astrophysicists as a whole despise the most: describe something mathematically.
...
The \footlink{Galactic Wolf-Rayet Catalogue}{http://pacrowther.staff.shef.ac.uk/WRcat} \parencite{rossloweSpatialDistributionGalactic2015} has a collection of 667\footnote{At time of time of writing, with the last update being August 2020.} known galactic WR stars, 106 of such stars are contained within a binary system, with 41 such binaries containing WC stars.
...
% Physical properties
WR104 is an archetypal example of a continuous WCd system, it is a comparatively tight binary with a semi-major axis of \SI{2.34}{\au} and a period of $\sim 241$ days.
