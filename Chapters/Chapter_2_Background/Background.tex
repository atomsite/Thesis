...
Carbon chemistry in dust grains is particularly fascinating, 

$sp^2$- (graphite) and $sp^3$-bonded (diamond) dust grains have been observed with characteristic emission lines, simple organic chemistry, such as hydrogenation and formaldehydes

Amorphous carbon grains are defined as a mixture of $sp^2$- and $sp^3$-bonded carbon, with no structural order or polymerisation \parencite{draine_interstellar_2003}.
These amorphous grains are the primary focus of this project, as they are the sole dust grain species observed in and around CWB systems.
These refractory dust grains are particularly hardy, and are significantly more shock resistant than other types of dust grain 

% Other grain types, PAHs, ice and silicates
Whilst amorphous carbon grains are the focus of this project, other species of interstellar dust are abundant throughout the ISM.
In particular, water ice, silicate grains and Polycyclic Aromatic Hydrocarbons (PAHs) are of particular note.

In addition, these grains are also markedly more resistant to interstellar 
...
We should quickly ask ourselves why any of this matters

% Interstellar dust grain species

Over 150 molecular species have been observed 

Such complex organic molecules include benzene, acetone and ethanol, 

Furthermore, there is strong evidence that the formation sites for these organic species is on the surface of interstellar dust grains, with gas-phase chemistry accounting for simple molecule formation.
...
As such, for all but the most massive stars to form, energy must be lost in the form of radiation \parencite{ward-thompsonIntroductionStarFormation2011}.
...
% Planetary formation
Interstellar dust is also crucial for the formation of planets, through fairly similar mechanisms. ELABORATE.
