...
\begin{figure}[ht]
  \centering
  \includegraphics{assets/cooling-curve/cooling-curve-solar-withev.pdf}
...
%%/TODO Include a graph of contribution due electron heating and ion heating for a dust grain with WC and solar abundances, can modify dust code to produce this graph, use integral method with more bins
