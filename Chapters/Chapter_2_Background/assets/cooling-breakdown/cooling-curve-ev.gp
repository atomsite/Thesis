...
set arrow from 1e5,1e-26 to 1e5,3e-20 nohead lc rgb 'red' dt 2 lw 4
...
plot 1 lc rgb "red" dt 2 lw 4 t "Excitation",\
     "cooling_curve_solar" u (10**$1):2 t "Solar" w l ls 1,\
