\chapter[An Exploration of Dust Growth Within WCd Systems]{\firstpapertitle{} \parencite{eatsonExplorationDustGrain2022}}
...
\begin{abstract}
  ...
  \small{
    ...
    However, in some extreme cases dust production yields of approximately 30\% of the total mass loss rate of the stellar winds have been \note{calculated \parencite{lauRevisitingImpactDust2020}}.
...
The shocks produced from this wind interaction creates some of the most luminous persistent \note{stellar mass} x-ray sources in the night sky \parencite{rossloweSpatialDistributionGalactic2015}.
...
In particularly energetic colliding wind binary (CWB) systems with a Wolf-Rayet (WR) star and OB-type partner, dust in the form of amorphous carbon grains has been observed to form \parencite{allenInfraredPhotometryNorthern1972}.
...
Additionally, dust may be protected from the bulk of the stellar radiation due to the extremely large degree of extinction that may occur in the dense post-shock environment of radiative shocks \note{\parencite{tuthill_prototype_2008,lauRevisitingImpactDust2020}}.
...
While $\xi \rightarrow 1$ in the case of cold, neutral gas \parencite{spitzerPhysicalProcessesInterstellar2008}, the sticking parameter for carbon grains decreases significantly
as the gas temperature increases \parencite{leitch-devlinStickingCoefficientsAtoms1985}.
...
This is \note{potentially due} to the leading edge interacting more strongly with the outflowing material due to the orbital motion of the stars, sweeping up material and obliquely shocking with the downstream WCR \note{\parencite{pittard_3d_2009}}. % This needs further work, but I think thats a working theory
...
\begin{figure}
  \centering
  \includegraphics{assets/cool-results/radiative-r2.pdf}
...
The data underlying this article is available in the Research Data Leeds Repository, at \link{https://doi.org/10.5518/1223}.