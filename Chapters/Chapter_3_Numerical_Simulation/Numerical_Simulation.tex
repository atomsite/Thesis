...
Numerical simulations - whilst extremely processing intensive - are a a class of problems that are considered to be \emph{embarrassingly parallel}.
...
This was compared to a a grid not undergoing refinement, with a resolution equivalent to the effective simulation of the AMR grid simulation of $(4096\times 1024)$ cells.
