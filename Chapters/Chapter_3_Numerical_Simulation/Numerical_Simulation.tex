...
\note{This feature, while impressive and useful for discerining whether a system is episodic or peristently dust forming, does not undergo significant dust formation, which instead occurs a short distance from the apex of the WCR \parencite{harriesThreedimensionalDustRadiativetransfer2004}}.
...
\begin{center}
  \turbo{This section has been significantly edited}
\end{center}
...
In order to get the required separation resolution for systems with close orbits, a very high coarse resolution was required, massively increasing memory usage and removing the benefits of mesh refinement.
...
\note{Radiative cooling also increases the resolution requirement, as the post-shock region can be significanly more compressed.}
...
\note{Other important assumptions for this model that must be justified involve the high temeprature of formation and dust growth, as well as the lack of immediate grain destruction through UV photodissociation and heating.}
...
\note{
  ...
  This is a typical floor temperature value of CWB simulations \parencite{pittard_3d_2009,parkinInvestigatingXrayEmission2011} due to this reason, and that it is more numerically stable when radiative cooling is introduced.
}
