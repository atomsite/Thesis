...
\note{
  We find that some of these binary systems can produce dust at similar rates to asymptotic giant branch stars ($\sim\SI{1e-5}{\solarmass\per\year}$ of dust; see \cite{lauRevisitingImpactDust2020}).
  ...
  Furthermore, in the first few hundred million years of the universe massive stars were more common and AGB stars were significantly rarer \parencite{morganDustFormationEarly2003}, these systems would therefore have had more influence on the dust content of the galactic interstellar medium \parencite{dwekOriginDustEarly2011,soulainSmokeWindDust2022a}.
  This primordial dust would then allow for more complex early chemistry than purely gas-phase interactions would allow \parencite{galliDawnChemistry2013}.
}
...
The episodic dust forming system WR140 was also simulated, whose \note{dust production variability} is theorised to be due to its high orbital eccentricity \note{\parencite{crowther_dust_2003}}.
...
\note{The structure of this thesis could be described as unconventional, this is because of two primary reasons:}
...
\note{While the primary objectives of this PhD were achieved, many aspects of this thesis that were planned at the start of the project were unfortunately truncated or removed.}
\note{This was extremely disappointing of course}, but I hope to continue work on this field outside of this PhD, and develop a more advanced dust model for numerical simulation.
...
% Paper chapters
\note{Afterwards, we will move on to Chapters \ref{chap:parameterspace} \& \ref{ch:wr140}.
These chapters have been adapted from two papers written concurrently with this thesis:}

\begin{enumerate}
  \item \note{\emph{\firstpapertitle} \parencite{eatsonExplorationDustGrain2022}.}
  \item \note{\emph{\secondpapertitle} \parencite{eatsonExploringDustGrowth2022}.}
\end{enumerate}
